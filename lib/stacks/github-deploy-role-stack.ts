...
export interface GithubDeployRoleStackProps extends StackProps {
	readonly deploymentEnvironment: PlatformDeployEnvironment;
	readonly awsEnvironment: AwsEnvironment;
}

const tagEnvironmentOf: Record<
	PlatformDeployEnvironment,
...
export class GithubDeployRoleStack extends Stack {
	public constructor(
		...
		applyPlatformTags(
			this,
			createPlatformTags(tagEnvironmentOf[props.deploymentEnvironment]),
		);
